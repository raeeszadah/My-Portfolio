      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center z-10">
        ...
        <div className="lg:col-span-7 text-left flex flex-col items-start justify-center">
          <div className="hero-item text-xs font-semibold text-brand-crimson tracking-[0.15em] uppercase mb-4 flex items-center gap-2">
            ...
            TECORITHAM BRANDED IDENTITY
          </div>

          <h1 className="hero-item font-display font-black text-5xl md:text-7xl tracking-tight text-white mb-6 uppercase leading-none">
            {profile?.name || 'TECORITHAM BUILDER'}
          </h1>
        ...
        <div className="lg:col-span-5 flex justify-center items-center relative">
          <div className="hero-item relative group">
            ...
            {/* Photo Container */}
            <div className="relative w-[280px] h-[280px] md:w-[360px] md:h-[360px] rounded-full overflow-hidden bg-black border-2 border-border-subtle/60 flex items-center justify-center shadow-[0_0_40px_rgba(255,0,27,0.25)]">
              <img
