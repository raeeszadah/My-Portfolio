...
export default function Login() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col justify-center items-center px-6 relative bg-black select-none">
      ...
      <div className="w-full max-w-md bg-surface-card border border-border-subtle p-8 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.8)] z-10 relative">
        <div className="text-center mb-8 flex flex-col items-center">
          <div className="size-12 rounded-full bg-brand-crimson-subtle/20 border border-brand-crimson/30 flex items-center justify-center text-brand-crimson mb-4 shadow-[0_0_15px_rgba(255,0,27,0.2)]">
